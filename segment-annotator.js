...
SegmentAnnotator = function(segmentation, options) {
  ...
  this.backgroundAlpha = options.fillAlpha || 0;
  this.fullFillAlpha = options.fillAlpha || 128;
  // Variables.
...
SegmentAnnotator.prototype._updateAnnotation = function(index, render) {
  ...
  if (render){
   ...
   /*  var cvs = document.createElement('canvas');
     ...
     console.log(data.length+','+pixels.length);
...
SegmentAnnotator.prototype._initializeAnnotationLayer = function() {
  ...
  this._setAnnotationAlpha(this.backgroundAlpha, false);
  return this;
};
 ...
 */
SLICSegmentAnnotator = function(image, options){
var _this = this;
